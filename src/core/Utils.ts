...
export class Utils {
   ...
   * @constant
   */
  static readonly RPGMAKER_VERSION = "1.9.0";

  private static _audioElement: HTMLAudioElement;
  private static _videoElement: HTMLVideoElement;
  private static _hasEncryptedImages: boolean;
  private static _hasEncryptedAudio: boolean;
