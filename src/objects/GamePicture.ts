...
export class GamePicture {
  ...
  private _easingType: EasingType;
  ...
  move(origin: number,x: number,y: number, scaleX: number,scaleY: number, opacity: number, blendMode: number, duration: number, easingType: EasingType) {
    this._origin = origin;
    this._targetX = x;
    this._targetY = y;
